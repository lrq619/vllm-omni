...
# from roll.third_party.vllm_omni.pipeline.scheduling_flow_match_sde_discrete import FlowMatchSDEDiscreteScheduler
# from roll.third_party.vllm_omni.pipeline.qwen_image_transformer import QwenImageTransformer2DModelFixed
...
class QwenImagePipelineWithLogProb(QwenImagePipeline):
    def __init__(self, *, od_config: OmniDiffusionConfig, prefix: str = ""):
        ...
        self.transformer = QwenImageTransformer2DModelStep(od_config=od_config)
    ...
    def diffuse(
        ...
        if all_log_probs and all_log_probs[0] is not None:
            ...
            all_log_probs = torch.zeros(
                (latents.shape[0], len(all_timesteps)),
                dtype=latents.dtype,
    ...
    def forward(
        ...
        print(f"init_latent_before_preaper: {latents}")
